...
const createCustomer = (customer, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    newUserAllData = yield users_model_1.User.findOne({ email: newUserAllData.email }).populate('customer');
...
const createSeller = (seller, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    newUserAllData = yield users_model_1.User.findOne({ email: newUserAllData.email }).populate('seller');
    return newUserAllData;
});
