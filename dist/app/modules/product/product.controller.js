...
const getProduct = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield product_service_1.ProductService.getProduct(filters, paginationOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateProduct = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sellerEmail = verifiedSeller === null || verifiedSeller === void 0 ? void 0 : verifiedSeller.userEmail;
    const id = req.params.id;
    const productData = req.body;
    const result = yield product_service_1.ProductService.updateProduct(id, sellerEmail, productData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const deleteProduct = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sellerEmail = verifiedSeller === null || verifiedSeller === void 0 ? void 0 : verifiedSeller.userEmail;
    const id = req.params.id;
    const result = yield product_service_1.ProductService.deleteProduct(id, sellerEmail);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
