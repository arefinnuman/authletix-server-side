...
const createProduct = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (yield product.populate('category')).populate(
      'seller'
    );
    return result;
  });
const getProduct = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateProduct = (id, userEmail, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((user === null || user === void 0 ? void 0 : user.role) === 'admin') {
      ...
      const seller = yield seller_model_1.Seller.findOne({
        _id: user === null || user === void 0 ? void 0 : user.seller,
      });
      if (!seller)
        throw new apiError_1.default(
          http_status_1.default.NOT_FOUND,
      ...
      const sellerEmail =
        seller === null || seller === void 0 ? void 0 : seller.email;
...
const deleteProduct = (id, userEmail) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const product = yield product_model_1.Product.findOne({ _id: id });
    if (!product)
      throw new apiError_1.default(
    ...
    let result;
    if ((user === null || user === void 0 ? void 0 : user.role) === 'admin') {
      result = yield product_model_1.Product.findOneAndDelete(
        { _id: id },
        { new: true }
      );
    } else {
