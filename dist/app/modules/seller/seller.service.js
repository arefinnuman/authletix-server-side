...
const getAllSeller = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateSeller = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { name } = payload, sellerData = __rest(payload, ["name"]);
    ...
    const result = yield seller_model_1.Seller.findOneAndUpdate({ _id: id }, updatedSellerData, {
        new: true,
    });
    return result;
});
const deleteSeller = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const seller = yield seller_model_1.Seller.findOneAndDelete({ email }, { session });
        if (!seller) {
