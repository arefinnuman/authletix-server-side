...
const getSingleAdmin = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield admin_model_1.Admin.findOne({ _id: id }).populate('ManagementDepartment');
    return result;
});
...
const deleteAdmin = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const admin = yield admin_model_1.Admin.findOneAndDelete({ _id: id }, { session });
        if (!admin) {
            throw new apiError_1.default(404, 'Failed to delete admin');
        }
        //delete user
        yield users_model_1.User.deleteOne({ _id: id });
