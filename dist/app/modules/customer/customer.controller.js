...
const getAllCustomer = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      customer_constant_1.studentFilterableFields
    );
...
const getSingleCustomer = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield customer_service_1.CustomerService.getSingleCustomer(
      id
    );
    if (result === null) {
      (0, sendResponse_1.default)(res, {
